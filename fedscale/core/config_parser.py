...
parser.add_argument('--sample_mode', type=str, default='random') #or oort
...
parser.add_argument('--rep_factor', type=float, default=1.0)
parser.add_argument('--wss', type=float, default=1.0)
parser.add_argument('--host_ip', type=str, default="10.52.0.181")
parser.add_argument('--port_num', type=str, default="6379")
parser.add_argument('--base_case', type=str, default='False')
parser.add_argument('--cache_traindata', type=str, default='False')
parser.add_argument('--cache_testdata', type=str, default='False')
parser.add_argument('--subs', type=float, default=0.0)
parser.add_argument('--mer_indices', type=float, default=0.0)
parser.add_argument('--fedcase', type=float, default=0.0)
parser.add_argument('--fedcaseimp', type=float, default=0.0)
...
args.base_case = eval(args.base_case)
args.cache_traindata = eval(args.cache_traindata)
args.cache_testdata = eval(args.cache_testdata)
