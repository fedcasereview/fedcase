...
def init_dataset():
    ...
    if parser.args.task == "detection":
        ...
        #                                     transform=test_transform)
            ...
            from fedscale.dataloaders.femnistmod import FEMNIST
            ...
            train_dataset = FEMNIST(
                parser.args.data_dir, dataset='train', transform=train_transform, cache_data = parser.args.cache_traindata,
        PQ=None, ghost_cache=None, key_counter= None, 
        wss = parser.args.wss, host_ip = parser.args.host_ip, port_num = parser.args.port_num)
            test_dataset = FEMNIST(
                parser.args.data_dir, dataset='test', transform=test_transform, cache_data = parser.args.cache_testdata,
        PQ=None, ghost_cache=None, key_counter= None, 
        wss = parser.args.wss, host_ip = parser.args.host_ip, port_num = parser.args.port_num)
            ...
            train_transform, test_transform = get_data_transform('cifar10')
